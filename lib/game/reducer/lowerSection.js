import { canGetDinkzeeBonus, isGameComplete, getDinkzeeBonus, scored } from './scoreUtils'
...
function setIfGameComplete (state) {
  state.gameComplete = isGameComplete(state.scores)
  return state
}

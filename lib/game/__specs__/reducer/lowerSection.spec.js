...
function assertGameComplete (func, score) {
  const state = {
    ...initialState,
    scores: {
      ...initialState.scores,
  ...
  state.scores[score] = { scored: false, value: 0 }
  const nextState = func(state, {})
...
describe('game/reducer/lowerSection', () => {
  describe('SET_3_OF_A_KIND', () => {
    ...
    it('should set gameComplete to true when all values have been set', () => {
      assertGameComplete(set3OfAKind, 'threeOfAKind')
    })
  })
  ...
  describe('SET_4_OF_A_KIND', () => {
    ...
    it('should set gameComplete to true when all values have been set', () => {
      assertGameComplete(set4OfAKind, 'fourOfAKind')
    })
  })
  ...
  describe('SET_FULL_HOUSE', () => {
    ...
    it('should set gameComplete to true when all values have been set', () => {
      assertGameComplete(setFullHouse, 'fullHouse')
    })
  })
  ...
  describe('SET_SMALL_STRAIGHT', () => {
    ...
    it('should set gameComplete to true when all values have been set', () => {
      assertGameComplete(setSmallStraight, 'smallStraight')
    })
  })
  ...
  describe('SET_LARGE_STRAIGHT', () => {
    ...
    it('should set gameComplete to true when all values have been set', () => {
      assertGameComplete(setLargeStraight, 'largeStraight')
    })
  })
  ...
  describe('SET_DINKZEE', () => {
    ...
    it('should set gameComplete to true when all values have been set', () => {
      assertGameComplete(setDinkzee, 'dinkzee')
    })
  })
  ...
  describe('SET_CHANCE', () => {
    ...
    it('should set gameComplete to true when all values have been set', () => {
      assertGameComplete(setChance, 'chance')
    })
  })
